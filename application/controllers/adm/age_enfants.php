...
class age_enfants extends CI_Controller {
...
//Visual
            ...
            $crud->columns('name_kids_age');
            $crud->display_as('name_kids_age', 'Age des enfants');
            $crud->order_by('name_kids_age', 'desc');
//unsets
//Requireds
            $crud->required_fields('name_kids_age');
//Callbacks
//field Types
// Actions
// Renders

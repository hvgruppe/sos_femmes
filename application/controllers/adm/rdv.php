...
//Visual
            ...
            $crud->columns('name_rdv');
            $crud->display_as('name_rdv', 'RDV');
            $crud->order_by('name_rdv', 'desc');
//unsets
//Requireds
            $crud->required_fields('name_rdv');
//Callbacks
//field Types
// Actions
// Renders
